...
std::vector<std::string> itemsToBuy = {"House", "Car", "Apple", "Banana", "Orange", "Chocolate", "Milk", "Cheese", "Coffee", "EnergyDrink", "Meat", "Phone", "Laptop", "T-Shirt", "Pants", "Shoes", "GiftBox", "BookC++", "ComicBook", "Mathematics", "Encyclopedia", "Poems", "Dictionary"};
std::vector<int> prices = {2500, 1000, 10, 15, 20, 25, 20, 35, 25, 30, 50, 1000, 2000, 100, 250, 50, 250, 75, 60, 45, 80, 40, 35};  // Fixed to match itemsToBuy size
std::vector<double> earningSell = {1250, 500, 5, 7.5, 10, 12.5, 10, 17.5, 12.5, 15, 25, 500, 1000, 50, 125, 25, 125, 37.5, 30, 22.5, 40, 20, 17.5};  // Fixed to match itemsToBuy size
std::vector<std::string> itemsToEat = {"Apple", "Orange", "Chocolate", "Milk", "Cheese", "Meat", "Energy Drink", "Coffee"};
std::vector<std::string> itemsToUse = {"Gift Box"};
std::vector<std::string> itemsToRead = {"Book about C++", "Comic book", "Mathematics book", "Encyclopedia", "Poems", "Dictionary"};
